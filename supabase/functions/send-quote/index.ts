      ...
      const html = `
        <div style="font-family:sans-serif;max-width:600px;margin:0 auto;">
          ...
          <div style="padding:24px;border:1px solid #e5e7eb;border-top:0;border-radius:0 0 12px 12px;">
            ...
            <p style="margin-top:24px;"><a href="${Deno.env.get('SITE_URL') || ''}/quote/${token}" style="background:#22c55e;color:white;padding:12px 24px;border-radius:8px;text-decoration:none;display:inline-block;">View & Respond to Quote</a></p>
          </div>
        </div>
      `
