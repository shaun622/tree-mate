...
export default function PublicQuote() {
  ...
  if (!quote) return <div className="min-h-screen flex items-center justify-center"><p className="text-gray-500">Quote not found</p></div>
    ...
    <div className="min-h-screen bg-gradient-page">
      <div className="max-w-lg mx-auto px-4 py-8 space-y-4">
        ...
        <div className="text-center">
          ...
          <h1 className="text-xl font-bold text-gray-900">{business?.name || 'Quote'}</h1>
        ...
        <Card className="p-6">
          ...
          <p className="text-sm text-gray-500 mb-4">Date: {formatDate(quote.created_at)}</p>
          ...
          <div className="space-y-1 text-sm">
            ...
            <div className="flex justify-between"><span className="text-gray-500">GST (10%)</span><span>{formatCurrency(quote.gst)}</span></div>
          ...
          {quote.scope && (
            <div className="mt-4 pt-4 border-t">
              <h3 className="font-medium text-gray-900 mb-1">Scope of Work</h3>
