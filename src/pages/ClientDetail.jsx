  ...
  return (
    <PageWrapper>
      ...
      <div className="px-4 py-4 space-y-4">
        ...
        {/* Add Job Site Button */}
        <button onClick={() => setShowSiteModal(true)} className="w-full flex items-center justify-center gap-2 p-4 rounded-2xl bg-tree-50 border-2 border-dashed border-tree-200 text-tree-700 font-medium hover:bg-tree-100 transition-colors">
