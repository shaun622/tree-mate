...
export default function UpgradePrompt({ message, onClose }) {
  ...
  return (
    <div className="bg-gradient-to-r from-tree-50 to-emerald-50 rounded-2xl p-5 border border-tree-100 ring-1 ring-tree-200/30">
      <div className="flex items-start gap-3">
        <div className="w-10 h-10 rounded-xl bg-tree-100 text-tree-600 flex items-center justify-center flex-shrink-0">
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 10-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H6.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
          </svg>
        </div>
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold text-gray-900">Upgrade required</p>
